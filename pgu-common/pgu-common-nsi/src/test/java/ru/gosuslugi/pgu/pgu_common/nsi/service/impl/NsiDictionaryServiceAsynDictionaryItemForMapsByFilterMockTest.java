 ...
 * @author ebalovnev
 */
public class NsiDictionaryServiceAsynDictionaryItemForMapsByFilterMockTest {
    ...
    public void test() throws URISyntaxException, ExecutionException, InterruptedException {
        ...
        Future<NsiDictionary> future = apiClient.asyncGetDictionaryItemForMapsByFilter("address", filterRequest);
        NsiDictionary response = future.get();
    ...
    public void testWithCode() throws URISyntaxException {
        ...
        try {
            apiClient.asyncGetDictionaryItemForMapsByFilter("address", filterRequest);
