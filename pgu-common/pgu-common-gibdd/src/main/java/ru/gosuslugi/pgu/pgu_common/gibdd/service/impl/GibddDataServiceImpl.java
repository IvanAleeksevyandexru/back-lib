...
public class GibddDataServiceImpl implements GibddDataService {
    ...
    private List<VehicleFullInfo> convertToVehicleFullInfoList(NsiDictionary dictionary) {
        ...
        Collection<List<NsiDictionaryItem>> vehiclesItems = dictionary.getItems()
            .stream()
    ...
    private VehicleFullInfo convertToVehicleFullInfo(List<NsiDictionaryItem> dictionaryItems,
        Map<String, String> ownerTypeMap,
        Map<String, String> statusMap, Map<String, String> ecologyClassMap, boolean hasSensitiveData) {
