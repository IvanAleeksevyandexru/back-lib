...
public class SmevConverterPullRequestDto {

    @JsonCreator
    public SmevConverterPullRequestDto(@JsonProperty("requestId") String requestId,
    ...
    @Schema(description = "id запроса в барбарбок", required = true)
    @NotNull
    @NotEmpty
